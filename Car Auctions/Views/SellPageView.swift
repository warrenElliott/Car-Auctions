                    ...
                    ScrollView{
                        ...
                        VStack{
                            ...
                            VStack{
                                ...
                                NavigationLink(destination: AdDetailView(adPreview: self.ad, bidHistory: []), isActive: self.$previewActive) {
                                    ...
                                    Text("Delete")
                                        .alert(isPresented: $showAlert, content: {
                                            Alert(title: Text("Permanently Delete Add?"), message: Text( "This action cannot be undone"), primaryButton: .default(Text("Got it!")){
                                                ...
                                                self.ad = AuctionSaleData(adId: "", adName: "", adDescription: "Enter your ad details here", adBid: "100", adEndingTime: "", adEndingDate: "", adAuthor: (UserDefaults.standard.value(forKey: "userEmail") as? String)!, adLocation: "", adImages: [], imageLinks: [], datePosted: "", isDraft: true, bidCount: "0", bidHistory: [])
